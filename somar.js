...
function calculartudo() {
	...
	var total = parseFloat(v1*10)+parseFloat(v2*12)+parseFloat(v3*16)+parseFloat(v4*32)+parseFloat(v5*52)+parseFloat(v6*13)+parseFloat(v7*40)+parseFloat(v8*60)+parseFloat(v9*5);
	var preco = "R$"+total;
